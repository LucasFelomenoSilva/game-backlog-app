        ...
        <nav className="sticky top-0 z-50 border-b" style={{ background: `${V.bg}d8`, backdropFilter: 'blur(24px)', borderColor: V.border }}>
          <div className="max-w-xl mx-auto px-5 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {onOpenBackup && (
                <button onClick={onOpenBackup} className="w-8 h-8 flex items-center justify-center rounded-xl transition-all hover:opacity-70" style={{ background: V.faint, border: `1px solid ${V.border}` }}>
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0 pt-1">
                ...
                <div className="space-y-1.5 mt-3">
                  ...
                  <p className="text-[10px]" style={{ color: V.low }}>{5 - (totalFinishedGames % 5)} jogos para o próximo nível</p>
                </div>
              </div>
            </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider" style={{ background: `linear-gradient(135deg, ${V.primary}, ${V.accent})`, color: 'white' }}>⭐ Favorito #1</span>
                          {favorites[0].isPlatinum && (
                            <span className="text-[9px] font-black px-2 py-0.5 rounded-full" style={{ background: 'rgba(245,158,11,0.25)', color: '#fbbf24', border: '1px solid rgba(245,158,11,0.4)' }}>🏆 Platina</span>
                          )}
                        </div>
