  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-4 pb-20">
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-6 rounded-3xl overflow-hidden shadow-2xl border border-gray-700 bg-gray-800 h-56 md:h-72 flex items-center justify-center relative group">
          ...
          <div className="absolute bottom-0 left-0 p-6 w-full">
            <div className="flex items-center gap-2 mb-2">
              <span
                className={`px-3 py-1 bg-black/60 backdrop-blur rounded-full text-xs border border-white/10 flex items-center gap-2 uppercase tracking-wide font-bold`}
              >
                {CurrentIcon && (
        ...
        {/* Game Info Card */}
        <div
          className={`bg-gray-800/50 backdrop-blur rounded-3xl p-6 border border-gray-700 mb-6 shadow-lg`}
        >
