...
export default function FriendProfileModal({
  ...
  const displayGames = useMemo(() => {
    ...
    let list =
      activeTab === "all" ? games : games.filter((g) => g.status === activeTab);
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl rounded-3xl border shadow-2xl overflow-hidden flex flex-col max-h-[80vh]"
          ...
          <div className="relative px-6 pt-6 pb-5">
            <div className="flex items-center gap-4">
              ...
              <div className="relative flex-shrink-0">
                ...
                <div className="relative w-20 h-20 rounded-2xl overflow-hidden border-2 border-white/20 shadow-xl">
                  {friendProfile?.photoURL ? (
                    ...
                    <div
                      className={`w-full h-full bg-gradient-to-br ${theme.tw.grad} flex items-center justify-center text-3xl font-black text-white`}
                    >
              ...
              <div className="flex-1 min-w-0 pr-10">
                ...
                <p className="text-sm text-cyan-400/80 font-mono mb-2">
                  {friendProfile?.userCode}
                </p>
            ...
            <div className="grid grid-cols-4 gap-2 mt-4">
              {[
                ...
                {
                  label: "Platinas",
                  value: stats.platinas,
                  color: "text-yellow-300",
                },
              ].map(({ label, value, color }) => (
                <div
                  key={label}
                  className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-2 text-center"
                >
            ...
            <button
              onClick={() => {
                onClose();
                onOpenChat(friendUid, friendProfile);
              }}
        ...
        <div>
          ...
          <div className="space-y-2">
            {topRated.map((game, i) => (
              <div
                key={game.id}
                className="flex items-center gap-3 p-3 bg-gray-800/40 rounded-xl border border-gray-700/40"
              >
                ...
                {game.imageBase64 ? (
                  <img
                    ...
                    alt={game.nome}
                    className="w-8 h-11 rounded-lg object-cover"
                  />
                ) : (
                ...
                <div
                  className={`flex items-center gap-1 px-2 py-1 rounded-lg bg-gradient-to-r ${getRatingColor(game.rating)}`}
                >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {game.isPlatinum && (
                      <span className="text-[9px] px-1.5 py-0.5 bg-yellow-500/20 text-yellow-300 rounded font-bold">
                        PLATINA
                      </span>
                    )}
                  </div>
                ...
                <div className="flex flex-col items-end gap-1">
                  {game.rating > 0 && (
                    <div
                      className={`flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-gradient-to-r ${getRatingColor(game.rating)}`}
                    >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <h4
                        className={`font-bold text-sm truncate ${isPlatinum ? "text-yellow-200" : isZerados ? "text-green-200" : "text-white"}`}
                      >
                        {game.nome}
                      </h4>
                      {isPlatinum && (
                        <div className="flex items-center gap-0.5 px-1.5 py-0.5 bg-gradient-to-r from-yellow-500 to-amber-500 rounded">
                          ...
                          <span className="text-[8px] font-black text-yellow-900">
                            PLATINA
                          </span>
                        </div>
                      )}
